...
const AddCourse = () => {
  ...
  const [lectureDetails, setLectureDetails] = useState({
    lectureTitle: "",
    lectureDuration: 0, // Changed from "" to 0 since it's a number
    lectureUrl: "",
    isPreviewFree: false,
  });
    ...
    <div className="h-screen overflow-scroll flex flex-col item-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      <form className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div ref={editorRef} className="max-w-2xl"></div>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            min={0}
            max={100}
            className="outline-none md:py-2.5 py-2 w-28 px-3 rounded border-1 border-gray-500"
            required
          />
        </div>
        ...
        <div>
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  ...
                  <div
                    className="inline-flex bg-gray-100 p-2 rounded cursor-pointer mt-2" onClick={()=>handleLecture('add',chapter.chapterId)}>
                    + Add Lecture
                  </div>
                </div>
              )}
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-cyan-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <div className="mb-2">
                  ...
                  <input
                    type="number"
                    className="mt-1 block w-full border rounded py-1 px-2"
                    value={lectureDetails.lectureDuration || ""} // Add fallback for empty state
                    onChange={(e) =>
                      setLectureDetails({
                        ...lectureDetails,
                        lectureDuration: Number(e.target.value) || 0, // Convert to number
                      })
                    }
                  />
                </div>
